...
daily_power_male_watt_per_seconds = daily_energy_need_male_in_kj / 3.6

robustness = daily_power_male_watt_per_seconds / (life_expectancy_in_seconds - age_in_seconds)
